        ...
        messages: [
            {
                role: "system",
                content: `
Write a 15-word review of "Never Trumpet with a Crumpet" published 2019 by Amy Gibson in perspective of a primary school learner non native speaker tone. Use only:
- Letters, commas, periods, and basic punctuation
- No line breaks (\n), asterisks, or special formatting
- Exactly 15 words
        ...
        messages: [
            {
                role: "system",
                content: `
Write a 15-word summary of "Never Trumpet with a Crumpet" published 2019 by Amy Gibson in perspective of a primary school learner non native speaker tone. Use only:
- Letters, commas, periods, and basic punctuation
- No line breaks (\n), asterisks, or special formatting
- Exactly 15 words
- Simple English words (A0 level)`,
